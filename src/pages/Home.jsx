...
function Home() {
  ...
  return (
    <div className="bg-white font-sans">
      <div className="w-full flex flex-row justify-between  items-center p-2 py-2  sm:px-6 shadow-lg border-b border-customGray border-solid fixed z-50">
      ...
      <section ref={homeRef} id="home" style={{ minHeight: "110dvh" }}>
        <div className="relative w-full border">
          <div className=" w-full flex flex-row justify-between m-auto items-center p-2">
            ...
            <div className="">
              <img src={"Homeimg1.svg"} alt="homeimg" className="p-2 mr-12" />
              {/*<img
  ...
  />*/}
      ...
      >
        <div
          ...
          className="w-full flex flex-row justify-between m-auto items-center bg-primaryGray bg-opacity-80 rounded-lg shadow-md"
        >
          <img
            src={"/aboutimg.svg"}
            alt="aboutimg"
          ...
          <p className="text-lg mb-8">
            ...
            finding balance and focus within a unified workspace. UniTask
            empowers you to thrive, both professionally and personally, by
            harmonizing task management with self-care practices.
          </p>
        </div>
      </section>

      <footer ref={contactRef} id="contact" className="py-6 px-6">
        <ContactForm />
        <p className="mt-6 p-6 border-t-2 border-customGray border-solid text-center">
          &copy; 2024 UniTask. All rights reserved.
        </p>
      </footer>
    </div>
  );
